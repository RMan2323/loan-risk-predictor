...
from DoubleRegression import DoubleLayerRegression  # Make sure you have your model class correctly imported
...
y = data['RiskScore'].values  # Adjust if needed
...
model = DoubleLayerRegression( hidden1=64, hidden2=64)

# Define loss function and optimizer
criterion = nn.MSELoss()  # For binary classification, use BCEWithLogitsLoss
...
print("Model saved as 'best_model_regression.pt'")
